...
@implementation AppDelegate (WPPlugin)
...
- (void)userNotificationCenter:(UNUserNotificationCenter *)center
    ...
    NSData *jsonData = [NSJSONSerialization dataWithJSONObject:userInfoMutable
                                                       options:0
                                                         error:&error];
    [WPPlugin.wpPlugin notifyOfMessage:jsonData];
...
- (void)tokenRefreshNotification:(NSNotification *)notification
{
    ...
    [WPPlugin.wpPlugin notifyOfTokenRefresh:refreshedToken];
...
- (void)applicationDidBecomeActive:(UIApplication *)application
{
    ...
    [WPPlugin.wpPlugin appEnterForeground];
    [self connectToFcm];
}
...
- (void)applicationDidEnterBackground:(UIApplication *)application
{
    ...
    [[FIRMessaging messaging] disconnect];
    [WPPlugin.wpPlugin appEnterBackground];
