...
public class WPFirebaseMessagingService extends FirebaseMessagingService {
  ...
  private MyWPDatabaseMessageStore mStore;
  ...
  public void onMessageReceived(RemoteMessage remoteMessage) {
    mStore = MyWPDatabaseMessageStore.getInstance(this);
    ...
    new Thread(new Runnable() {
      ...
      public void run() {
        try {
          ...
          int count = mStore.count(msg.getId());
          Log.d(TAG, count > 0 ? "Exist FCM Message:" + msg.toString()
            : "Not exist FCM Message:" + msg.toString());
